...
| **Next.js BFF** | Spoofing | Обход аутентификации страниц | **ASVS V3.1:** `middleware.ts` валидирует наличие и срок жизни подписанной сессии. Защищённые маршруты автоматически редиректят на `/login`. | Исправлено / Frontend |
